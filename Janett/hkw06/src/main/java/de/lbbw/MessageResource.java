...
public class MessageResource {
	...
	private MessagesController controller = null;
	...
	// curl -X PUT -v -H "Content-Type: application/json" -d "{\"material\":\"Holz\"}" http://localhost:8080/api/message
...
//			return Response.status(Status.UNAUTHORIZED).build();
	//	} else {
			try {
				...
				System.out.println("Message gelesen: " + m.toString());
