...
public class Ofen {
	...
	public Ofen(int istTemperatur, int sollTemperatur, int kuehlTemperatur) {
		bk = new Brennkammer();
	...
	public void beladen(Object material) {
		...
		try {
			...
			System.out.println("Hinweis: das Material "+material.getClass().getName()+" kannn nicht verbrannt werden");
		} 	
	}
